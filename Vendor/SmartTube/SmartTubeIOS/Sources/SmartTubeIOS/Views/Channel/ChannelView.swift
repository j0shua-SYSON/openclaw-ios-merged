...
public struct ChannelView: View {
    ...
    public var body: some View {
        ...
        #endif
        // A real binding, not .constant: the alert's dismissal must clear vm.error,
        // otherwise SwiftUI re-presents it immediately and the screen is stuck in an
        // un-dismissable alert loop after a single failed fetch.
