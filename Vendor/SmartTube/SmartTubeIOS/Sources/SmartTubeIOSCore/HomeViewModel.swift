...
public final class HomeViewModel {
    ...
    public func updateAuthToken(_ token: String?) async {
        ...
        if token != nil && !wasAuthenticated {
            ...
            // Sign-out: rebuild with unauthenticated content — otherwise the previous
            // account's personalized Recommended/Subscriptions shelves stay on screen
            // until refreshIfStale's 15-minute threshold. Mirrors BrowseViewModel.
            load()
        }
    }
