...
public extension Video {
    ...
    var formattedViewCount: String {
        ...
        case 1_000_000..<1_000_000_000: return String(format: "%.1fM views", Double(viewCount) / 1_000_000)
        default:              return String(format: "%.1fB views", Double(viewCount) / 1_000_000_000)
        }
    }
